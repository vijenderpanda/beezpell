  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-amber-50 flex flex-col items-center justify-center p-6">
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Welcome to Word Journey Lab!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl w-full">
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Card
            className="p-8 cursor-pointer hover:shadow-xl transition-all border-2 border-transparent hover:border-primary group"
            onClick={() => handleChoose('guide')}
          >
            <div className="text-center">
              <div className="w-20 h-20 bg-primary-light rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:bg-primary group-hover:text-white transition-all">
                <BookOpen className="w-10 h-10 text-primary group-hover:text-white" />
              </div>
              <h2 className="text-2xl font-bold text-gray-800 mb-3">I'm a Guide</h2>
              <p className="text-gray-500 leading-relaxed">
                Empower yourself to teach young minds spelling and vocabulary.
                Upload stories, manage learners, and track their progress.
              </p>
              <div className="mt-6 flex flex-wrap gap-2 justify-center">
                {['Teacher', 'Parent', 'Tutor', 'Sibling'].map(tag => (
